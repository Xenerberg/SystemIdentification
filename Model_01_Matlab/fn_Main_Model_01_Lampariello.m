...
function [ ] = fn_Main_Model_01_Lamariello( )
    ...
    global totalSimulationTime;totalSimulationTime = 672.2;        
...
%     
    ...
    Init_Model_01_Matlab_Lampariello;   
    ...
    X_a_0_sim = load('./Model_01_Matlab/X_a_0_Lampariello');
    ...
    for iCount = 1:3
       subplot(3,1,iCount);
       plot(rho_t_b(iCount,:));
       ylabel(strcat('rho_t_',num2str(iCount)));
    end
    simData = struct('X_a',X_a','rho_t',rho_t_b);
    save('./Model_01_Matlab/simTestLampariello.mat','simData')
    %%    
